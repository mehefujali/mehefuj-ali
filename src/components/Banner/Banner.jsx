      ...
      <div className=" container gap-4 mx-auto flex flex-col-reverse md:flex-row items-center justify-between">
        <div className="md:w-6/12 w-11/12 mx-auto">
          <div className="  flex flex-col gap-2">
            ...
            <h1 className=" text-primary-color font-bold text-2xl md:text-4xl xl:text-5xl">
            Web Developer
            </h1>
            <p>{`
            ...
            <div className=" mt-2  flex  items-center gap-2">
                  <Link to='https://github.com/mehefujali' target="_blank" className=" text-4xl"><BsGithub /></Link>
                  <Link to='https://www.linkedin.com/in/mehefuj-ali-232741306' target="_blank" className=" text-4xl"><FaLinkedin /></Link>
                  <Link to='https://www.facebook.com/kiron8391' target="_blank" className=" text-4xl"><FaFacebook /></Link>
                  <Link to='https://www.instagram.com/kiron_developer' target="_blank" className=" text-4xl"><FaInstagram /></Link>
            </div>
            {/* btns  */}
            <div className=" mt-3">
                  <button className=" flex items-center gap-2  hover:scale-105 active:scale-95 duration-150 bg-primary-color text-black p-3 rounded text-sm px-3">Download Resume <MdOutlineArrowDownward /></button>
            </div>
          </div>
        </div>
